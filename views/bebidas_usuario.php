    ...
    <section class="bebidas-section">
        <div class="bebidas-grid" id="bebidasGrid">
            ...
            foreach ($bebidas as $i => $bebida):
                ...
                $fecha      = $bebida['fecha'] ? date('d/m/Y', strtotime($bebida['fecha'])) : '—';
            ?>
...
<div class="card-img">
    ...
    <?php endif; ?>
                ...
                <div class="card-body">
                    <div class="card-id"># <?= $bebida['id'] ?></div>
...
$imgCart = (!empty($bebida['imagen']))
    ...
    : '../assets/img/default.jpg';
?>
onclick="addToCart(<?= $bebida['id'] ?>, '<?= addslashes($nombreSafe) ?>', <?= $bebida['precio'] ?>, '<?= $emoji ?>','<?= $imgCart ?>')"
