...
.platos-table tbody td {
    padding: 12px 16px;
    border-top: 1px solid rgba(255,255,255,.04);
    color: #e2e8f0; vertical-align: middle;
}

.platos-table tbody tr:hover td { background: #1b1e28; }
...
.plato-thumb-placeholder svg { width: 20px; height: 20px; stroke: #334155; }
...
<div class="content-area">
    ...
    <!-- FORM AGREGAR -->
    <form action="../controllers/platosController.php"
          method="POST"
    ...
    <div class="table-card">
        <div class="table-responsive">
            <table class="platos-table" id="platos-table">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Imagen</th>
                ...
                <tr>
                    ...
                    <td class="td-actions">
                        <div class="btn-actions">
                            ...
                            <a href="../controllers/platosController.php?eliminar=<?= $row['id'] ?>"
                               class="btn-delete"
...
<div class="toast-msg" id="toast">
    ...
    <span id="toast-text">Plato actualizado</span>
</div>

<script>
/* ── Count badge ── */
document.getElementById("count-badge").querySelector("span").textContent =
    document.querySelectorAll(".platos-table tbody tr:not(.empty-row)").length + " registros";
...
function showToast(msg, isError) {
    ...
    document.getElementById("toast-text").textContent = msg || "Plato actualizado";
    if (isError) {
...
document.querySelectorAll(".guardar").forEach(function(btn) {
    ...
    btn.addEventListener("click", function() {
        ...
        fetch("../controllers/platosController.php", { method: "POST", body: fd })
            ...
            if (data.trim() === "ok") {
                ...
                if (imgFile) {
                    ...
                    if (thumbWrap.tagName === "IMG") {
                        ...
                        img.src = url; img.className = "plato-thumb"; img.id = "thumb-" + id;
