...
<div class="content-area">
    ...
    <form action="../controllers/platosController.php"
        ...
        <div class="form-grid">
            ...
            <button type="submit" class="btn-agregar">Agregar plato</button>
                    ...
                    <tr>
                        ...
                        <td class="td-img">
                            <div class="img-edit-wrap">
                                ...
                                <?php else: ?>
                                    <div class="plato-thumb-placeholder"
                                         id="thumb-<?= $row['id'] ?>">🍽</div>
                                <?php endif; ?>
...
document.getElementById("count-badge").textContent =
    document.querySelectorAll(".platos-table tbody tr").length + " registros";
...
document.querySelectorAll(".guardar").forEach(btn => {
    ...
    btn.addEventListener("click", function(){
        ...
        fetch("../controllers/platosController.php", {
            method: "POST",
